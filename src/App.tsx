  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        ...
        {/* sync_v1.0.25 */}
        <p className="text-slate-500 text-[10px] tracking-[0.4em] font-bold mt-2 uppercase">{t.coreSystem} v1.0.25</p>
      </div>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      ...
      <footer className="mt-8 flex justify-between items-center text-slate-500 text-[10px] font-bold uppercase tracking-widest">
        ...
        <span className="flex items-center gap-2 italic text-slate-600">v1.0.25-{t.stable}</span>
      </footer>
    </motion.div>
  );
}
